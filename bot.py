...
APP_VERSION = "2026.08.29-channel-v3"
...
def register_book(message):
    ...
    books = load_books()
    books[book_key(title)] = {"title": title, "file_id": file_id, "file_name": file_name, "updated_at": message.get("date"), "source_chat_id": message.get("chat", {}).get("id"), "source_message_id": message.get("message_id")}
    save_books(books)
