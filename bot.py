...
# Папка, куда позже положим PDF-книги
BOOKS_DIR = "books"
    ...
    if not book:
        ...
        tg(
            "sendMessage",
            {
                "chat_id": chat_id,
                "text": (
                    "⚠️ Я определил твою книгу:\n\n"
                    f"📕 {title}\n\n"
                    "Но файл книги пока не подключён "
                    "к серверу.\n\n"
                    "Результат сохранён."
                )
            }
        ...
        tg(
            "sendMessage",
            {
                ...
                "text": (
                    ...
                    "📕 Твоя книга:\n"
                    f"{real_title}\n\n"
                    "Но сам PDF пока не загружен "
                    "на сервер.\n\n"
                    "Нужно добавить файл книги "
                    "в папку books."
                )
            }
        )
