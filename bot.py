...
PRICE_STARS = 200
DB_PATH = Path(os.getenv("DB_PATH", "data/quiz_users.json"))
BOOKS_DB_PATH = Path(os.getenv("BOOKS_DB_PATH", "data/telegram_books.json"))
EVENTS_PATH = Path(os.getenv("EVENTS_PATH", "data/telegram_events.json"))
